...
import org.powernukkitx.command.simple.Arguments;
import org.powernukkitx.command.simple.CommandParameters;
import org.powernukkitx.command.simple.CommandPermission;
import org.powernukkitx.command.simple.ForbidConsole;
import org.powernukkitx.command.simple.Parameters;
import org.powernukkitx.command.simple.SimpleCommand;
...
public class SimpleCommandMap implements CommandMap {
    ...
    public void registerSimpleCommands(Object object) {
        for (Method method : object.getClass().getDeclaredMethods()) {
            org.powernukkitx.command.simple.Command def = method.getAnnotation(org.powernukkitx.command.simple.Command.class);
            if (def != null) {
