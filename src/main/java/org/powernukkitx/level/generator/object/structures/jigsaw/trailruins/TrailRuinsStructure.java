package org.powernukkitx.level.generator.object.structures.jigsaw.trailruins;

import org.powernukkitx.block.Block;
import org.powernukkitx.block.BlockBrushable;
...
import org.powernukkitx.block.BlockSuspiciousGravel;
...
import static org.powernukkitx.block.BlockAir.STATE;
import static org.powernukkitx.block.BlockID.BLUE_STAINED_GLASS_PANE;
import static org.powernukkitx.block.BlockID.BROWN_CANDLE;
import static org.powernukkitx.block.BlockID.DEADBUSH;
import static org.powernukkitx.block.BlockID.FLOWER_POT;
import static org.powernukkitx.block.BlockID.GREEN_CANDLE;
import static org.powernukkitx.block.BlockID.LIGHT_BLUE_STAINED_GLASS_PANE;
import static org.powernukkitx.block.BlockID.MAGENTA_STAINED_GLASS_PANE;
import static org.powernukkitx.block.BlockID.OAK_HANGING_SIGN;
import static org.powernukkitx.block.BlockID.PINK_STAINED_GLASS_PANE;
import static org.powernukkitx.block.BlockID.PURPLE_CANDLE;
import static org.powernukkitx.block.BlockID.PURPLE_STAINED_GLASS_PANE;
import static org.powernukkitx.block.BlockID.RED_CANDLE;
import static org.powernukkitx.block.BlockID.RED_STAINED_GLASS_PANE;
import static org.powernukkitx.block.BlockID.SPRUCE_HANGING_SIGN;
import static org.powernukkitx.block.BlockID.WHEAT;
import static org.powernukkitx.block.BlockID.YELLOW_STAINED_GLASS_PANE;
...
public class TrailRuinsStructure extends JigsawStructure {
    ...
    private void replaceRandomGravel(BlockManager blockManager, List<Block> gravelBlocks, RandomSourceProvider random, int count, org.powernukkitx.block.BlockState replacement, TrailRuinsLoot loot) {
