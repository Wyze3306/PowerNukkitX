...
import org.powernukkitx.config.category.BaseSettings;
import org.powernukkitx.config.category.ChunkSettings;
import org.powernukkitx.config.category.DebugSettings;
import org.powernukkitx.config.category.GameplaySettings;
import org.powernukkitx.config.category.LevelSettings;
import org.powernukkitx.config.category.MiscSettings;
import org.powernukkitx.config.category.NetworkSettings;
import org.powernukkitx.config.category.PerformanceSettings;
import org.powernukkitx.config.category.PlayerSettings;
import org.powernukkitx.config.legacy.LegacyServerProperties;
import org.powernukkitx.config.legacy.LegacyServerPropertiesKeys;
